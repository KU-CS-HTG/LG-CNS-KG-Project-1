...
| 역량 이름 (통제 어휘) + IS_A 계층 | 팀이 직접 관리 → `vocab.py` (`CANON`, `PARENT`) | 대표 표기 123개 / 부모 21개 (어휘 3단계 반영) |
...
| IS_A 한 홉으로 이어지는 직무 역량 | — | **70** (AWS, Docker, Kubernetes, Java, Python, React, Spring Boot, LLM, RAG, CATIA, Simulink, Electrochemistry, Process Engineering, Power Systems, Digital Marketing …) |
...
- [ ] PR 머지: `feat/vocab-stage3` (어휘 3단계 + 데이터 재생성. A 승인 완료)
...
- [ ] 발표 4·5장 수치 갱신: 전공 61 / 직무 108(신입 75) / 어휘 123 / 공통 Skill 28 / IS_A 70 / 관계 5종 / 평가셋 12건(10/10 · 2/2). "개수를 지정하면 지어낸다" 사례 4개(정확히 3개 · 4~8개 · 최대 5개 · 3문장 이상)
