...
| 역량 이름 (통제 어휘) + IS_A 계층 | 팀이 직접 관리 → `vocab.py` (`CANON`, `PARENT`) | 대표 표기 140개 / 부모 22개 (어휘 3단계 + 팀원 9/16 확장 통합) |
...
| IS_A 한 홉으로 이어지는 직무 역량 | — | **76** (AWS, Docker, Kubernetes, Java, Python, React, Spring Boot, LLM, RAG, CATIA, Simulink, Electrochemistry, Process Engineering, Power Systems, Circuit Design, Telecommunications, Digital Marketing …) |
...
- [ ] 발표 4·5장 수치 갱신: 전공 61 / 직무 108(신입 75) / 어휘 140 / 공통 Skill 29 / IS_A 76 / 관계 5종 / 평가셋 12건(10/10 · 2/2). "개수를 지정하면 지어낸다" 사례 4개(정확히 3개 · 4~8개 · 최대 5개 · 3문장 이상)
